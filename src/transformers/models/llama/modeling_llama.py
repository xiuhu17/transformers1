...
class LlamaModel(LlamaPreTrainedModel):
    ...
    def _update_causal_mask(
        ...
        if (self.config._attn_implementation == "sdpa" or self.config._attn_implementation == "ulysses") and not using_static_cache and not output_attentions:
        ...
        if (
            (
                ...
                or self.config._attn_implementation == "ulysses"
            )
